    ...
    <section className={styles.skills_container}>
      ...
      <ul className={styles.skills} aria-label="Skills">
        ...
        <li>
          ...
          <br />- Hooks API
          <br />- has high affinity to TypeScript especially its data store like
          redux with it
          <br />
          <br />I usually develop an web-app with Next.js even if it does not
          require SSR/SSG because;
        ...
        <li>
          <h3>Python</h3>I was researching text summarization methods using
